...
echo ""
echo "    # 매주 일요일 오후 9시 주간 리포트 생성"
echo "    0 21 * * 0 cd $SCRIPT_DIR && python3 main.py >> $SCRIPT_DIR/report.log 2>&1"
echo "    # 매월 1일 오후 9시 월간 리포트 생성"
echo "    0 21 1 * * cd $SCRIPT_DIR && python3 monthly_main.py >> $SCRIPT_DIR/report.log 2>&1"
echo ""
echo "  또는 아래 명령으로 자동 등록:"
echo "    bash $SCRIPT_DIR/cron_register.sh           # 주간"
echo "    bash $SCRIPT_DIR/cron_register_monthly.sh   # 월간"
echo ""
